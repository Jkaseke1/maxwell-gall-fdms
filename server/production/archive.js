...
class Archive {
  ...
  log(type, data = {}) {
    const body = { id: this.events.length + 1, timestamp: new Date().toISOString(), deviceId: 46158,
  ...
  export() { return { company: 'MAXWELL GLASS', deviceId: 46158, environment: 'PRODUCTION', exportedAt: new Date().toISOString(),
