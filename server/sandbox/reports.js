function reports(state, config) {
  ...
  return days.map(day => {
    ...
    return { fiscalDayNo:day, type:closed ? 'Z REPORT' : 'X REPORT', environment:'TEST', deviceId:38293, serial:'TEST-2000945150-B670',
